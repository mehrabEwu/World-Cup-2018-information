...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="well">
            <h3 style="color:black">Player List of {{$cnty}} </h3>
  ...
  <ul class="list-group">
    ...
    <a href="{!! action('plUpdateController@edit', $player->slug) !!}">  <li style="font-weight: bold; font-size: 1em; color: green" class="list-group-item">{{$player->pname}}</li></a>
      @endforeach
  </ul>
